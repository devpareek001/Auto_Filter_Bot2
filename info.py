...
API_ID = int(environ.get('API_ID', '31312144')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'd71f76b181c759c458b4ba684145532a')  # API Hash from my.telegram.org
