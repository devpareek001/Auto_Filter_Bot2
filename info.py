...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002245108673'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002245108673'))  # Premium logs channel id
